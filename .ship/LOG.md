...
- wrote tests/visual.spec.ts: 12 screenshot tests for all pages, simulation states, nav active states (maxDiffPixelRatio:0.01, dynamic value masking)
- replaced basic-mode Table with card list (compact+expanded rows, density toggle, isoToFlag, bond dot, stake delta arrow, click-to-copy pubkey); added Stake Δ + Constraint columns to expert mode table
