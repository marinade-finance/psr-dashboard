...
| **SAM Active**  | Currently active stake delegated by SAM. A colored arrow (↑ green / ↓ red) flags expected stake change next epoch. Hover for stake breakdown, commissions (Inflation / MEV / Block), and this epoch's charge (activated + activating cost)                                          |
