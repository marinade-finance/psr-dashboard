...
| **Cover. [ep]** | Epochs of bond runway above the minimum required reserve. At 0, SAM starts capping stake; negative means the bond is short of the reserve by that many epochs of max-bid payments. Color: green = 13+, yellow = 6–12, orange = 2–5, red ≤ 1                                         |
