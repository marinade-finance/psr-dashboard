...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      'sticky top-0 bg-muted text-muted-foreground cursor-pointer select-none z-[1]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'hover:bg-primary-light-05 [&:last-child_td]:border-b-0',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'relative px-4 py-2.5 whitespace-nowrap text-sm font-mono border-b border-border-grid',
      className,
    )}
    {...props}
  />
