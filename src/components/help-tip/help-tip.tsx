...
export const HelpTip = ({ text }: HelpTipProps) => {
  ...
  return (
    <span className="relative inline-flex">
      ...
      {show && (
        <div className="absolute bottom-[calc(100%+6px)] left-1/2 -translate-x-1/2 w-[260px] px-3 py-2.5 rounded-md bg-gray-900 text-white text-[11px] leading-relaxed font-normal font-sans z-[200] shadow-lg pointer-events-none">
          {text}
