...
import { loadSam, SourceDataOverrides } from "src/services/sam";
import { Loader } from "src/components/loader/loader";
import { SamTable, SimulationInputs } from "src/components/sam-table/sam-table";
...
const buildSourceDataOverrides = (inputs: SimulationInputs): SourceDataOverrides | null => {
    ...
    if (inputs.inflationCommission !== null) {
        ...
        overrides.inflationCommissions.set(inputs.voteAccount, inputs.inflationCommission * 100)
    }
    ...
    if (inputs.blockRewardsCommission !== null) {
        // User enters percentage (e.g., 5 for 5%), SDK expects basis points (e.g., 500 for 5%)
        overrides.blockRewardsCommissions.set(inputs.voteAccount, inputs.blockRewardsCommission * 100)
    }
