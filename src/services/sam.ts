...
// Deduplicate concurrent no-override loadSam() calls: all callers share one SDK
// run (7 API requests) for up to 5 minutes. Simulation overrides bypass the cache.
