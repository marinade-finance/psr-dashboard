...
export namespace SettlementReason {
  ...
  export type CommissionIncreaseReason = {
    CommissionIncrease: ProtectedEvent.CommissionIncrease
  }
  export type LowCreditsReason = { LowCredits: ProtectedEvent.LowCredits }
  export type DowntimeRevenueImpactReason = {
    DowntimeRevenueImpact: ProtectedEvent.LowCredits
  }
  export type CommissionSamIncreaseReason = {
    CommissionSamIncrease: ProtectedEvent.CommissionSamIncreaseReason
  }
  ...
  ): e is CommissionIncreaseReason => 'CommissionIncrease' in (e as any)
  export const isLowCreditsReason = (
    e: ProtectedEventReason,
  ): e is LowCreditsReason => 'LowCredits' in (e as any)
  export const isDowntimeRevenueImpactReason = (
    e: ProtectedEventReason,
  ): e is DowntimeRevenueImpactReason => 'DowntimeRevenueImpact' in (e as any)
  export const isCommissionSamIncreaseReason = (
    e: ProtectedEventReason,
  ): e is CommissionSamIncreaseReason => 'CommissionSamIncrease' in (e as any)
}
