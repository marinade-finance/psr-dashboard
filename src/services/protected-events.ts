...
export type SettlementReason = ProtectedEventSettlement | 'BidTooLowPenalty' | 'BlacklistPenalty'
...
export const isBlacklistPenalty = (e: SettlementReason): boolean => e == 'BlacklistPenalty'
