...
| `concentration.ts`     | Country / ASO group share of TOTAL NETWORK stake, the basis the network caps are enforced on. Shadows ds-sam-calc's same-named one; re-exported by `sam.ts`.                                                                                                       |
