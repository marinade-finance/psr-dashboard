...
| Stake     | `targetStake` | **Primary metric** (bold, first after Validator). Current active SAM stake (`marinadeActivatedStakeSol`) in bold `text-foreground`, followed by the signed gap to the auction target rendered inline as `(+ N SOL)` / `(− N SOL)` — `selectSamTargetStake − active`. **Tint tracks the funded next-epoch change (`expectedStakeChangeSol`), not the gap's own sign:** `var(--status-green)` when stake actually arrives (delta > 0), `var(--destructive)` when it leaves (delta < 0), muted (`--muted-foreground`) when the change is flat (`\|delta\| < 1`) — so a target the redelegation budget won't fund this epoch shows muted, not green, and never contradicts a `Raise bid to grow stake.` Next Step. Gap is hidden when `\|gap\| < 1`. **Sort key (`targetStake`) is the sum** `active + gap = selectSamTargetStake` (the target allocation), so the column orders validators by where the auction is steering their stake.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
